        ...
        <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {step === 1 && (
                <form onSubmit={handleEmailSubmit(onEmailSubmit)} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        className="w-full flex items-center justify-center gap-2 rounded-xl bg-[#1e2e4a] hover:bg-[#152238] px-5 py-3 text-sm font-semibold text-white transition-colors disabled:opacity-50"disabled={loading}
                    >
            ...
            {step === 3 && (
                <form onSubmit={handleResetSubmit(onResetSubmit)} className="space-y-6">
                    ...
                    <button
                        ...
                        disabled={loading}
                    >
                        {loading ? <Loader2 size={16} className="animate-spin" /> : <span>Reset Password</span>}</button>
                </form>
            )}
        </div>
    )
